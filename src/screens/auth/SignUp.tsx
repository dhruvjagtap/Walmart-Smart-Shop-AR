    ...
    >
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Login')}>
        <Text style={styles.text}>
          ...
          <Text style={{ color: '#fb8500' }}>Login</Text>
        </Text>
      </TouchableOpacity>
    </KeyboardAvoidingView>
  );
...
// is this good sign up page how can we make it more better and i am not able to see the Iconicon here what might be the reason
